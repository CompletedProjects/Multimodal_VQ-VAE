...
def main():
    ...
    for i in itertools.count():
        ...
        bottom_enc = vae.encoders[0].encode(images) # Nawid - Uses the first encoder layer to encoder the bottom latent map
        _, _, bottom_idxs = vae.encoders[0].vq(bottom_enc) # Nawid- Quantises the latent map into indices
