...
def make_vq_vae():
    return VQVAE([QuarterEncoder(3,1,LATENT_SIZE, LATENT_COUNT)], # Nawid - Change to take into the different number of channels present for both the different inputs
