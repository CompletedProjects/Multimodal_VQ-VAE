...
def make_vae(): # Nawid - Makes the encoder and the decoder
    encoders = [QuarterEncoder(3, 128, 512), HalfEncoder(128, 128, 512)] # Nawid -For the first encoder, the number of input channels is 3 for RGB images, 1 for grayscale and 4 for concatenation of RGB and Grayscale images and it produces 128 output. The 512 is the number of latents in the dictionary
